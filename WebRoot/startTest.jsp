	...
	<form action="getScoreServlet" method="post">
		<c:forEach var="pro" items="${prolist}">
			<table class="table">	        
	            ...
	            <tr>
	            	<td><input type="radio" name="${pro.getPid()}" value="B"> B ${pro.getOptionB()}</td>
	            </tr>
	            <tr>
	                <td><input type="radio" name="${pro.getPid()}" value="C"> C ${pro.getOptionC()}</td>
	            </tr>
	            <tr>
	                <td><input type="radio" name="${pro.getPid()}" value="D"> D ${pro.getOptionD()}</td>
	            </tr>              
<!-- 	            <tr>
	            	<td></td>
	            </tr> -->	            
